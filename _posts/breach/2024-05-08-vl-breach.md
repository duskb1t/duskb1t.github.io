...
**Breach** is a medium VL machine where you have to **poison an SMB share** to get credentialed and perform a **Kerberoasting attack** against a machine account that has weak password to move laterally. Once compromised, privilege escalation to Domain Admins is right around the corner.
